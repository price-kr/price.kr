...
| # | Task | 상태 | 비고 |
|---|------|------|------|
| 1 | Incremental KV Sync (commit-based diff) | ✅ 완료 | __sync_commit__ marker, git diff --name-status, bulk put/delete, chunking, dry-run, rename support, same-key rename safeguard, workflow path exclusions restored |
